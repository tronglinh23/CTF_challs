...
public class q extends ImageButton implements androidx.core.view.r1, k1.e0 {
    private final f mBackgroundTintHelper;
    private boolean mHasLevel;
    private final r mImageHelper;

    public q(@d.o0 Context context) {
        this(context, null);
    }
    ...
    public q(@d.o0 Context context, @d.q0 AttributeSet attributeSet) {
        this(context, attributeSet, a.b.K1);
    }

    public q(@d.o0 Context context, @d.q0 AttributeSet attributeSet, int i7) {
