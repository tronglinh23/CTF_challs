...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@o0 View view, boolean z6, boolean z7, @o0 List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofFloat;
        MotionTiming motionTiming = z6 ? this.expandTiming : this.collapseTiming;
        if (z6) {
            if (!z7) {
                view.setAlpha(0.0f);
            }
    ...
    @o0
    public AnimatorSet onCreateExpandedStateChangeAnimation(@o0 View view, @o0 final View view2, final boolean z6, boolean z7) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z6, z7, arrayList, new ArrayList());
