...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public interface ShapeProvider {
        @q0
        ShapeAppearanceModel provideShape(@o0 View view);
    }
    ...
    public static class ShapeableViewShapeProvider implements ShapeProvider {
        ...
        @q0
        public ShapeAppearanceModel provideShape(@o0 View view) {
    ...
    public static void removeWindowBackground(Window window) {
        ...
        windowBackground.mutate().setColorFilter(i.a(0, j.CLEAR));
    }
    ...
    public void setShapeProvider(@q0 ShapeProvider shapeProvider) {
        this.shapeProvider = shapeProvider;
    }

    public void setSharedElementReenterTransitionEnabled(boolean z6) {
        this.sharedElementReenterTransitionEnabled = z6;
    }

    public void setTransparentWindowBackgroundEnabled(boolean z6) {
        this.transparentWindowBackgroundEnabled = z6;
    }
}
