...
public final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    public LinearIndeterminateContiguousAnimatorDelegate(@o0 LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        super(3);
    ...
    private void updateSegmentPositions(int i7) {
        ...
        float fractionInRange = getFractionInRange(i7, 0, TOTAL_DURATION_IN_MS);
