...
public class TextInputEditText extends androidx.appcompat.widget.m {
    ...
    @o0
    private String getAccessibilityNodeInfoText(@o0 TextInputLayout textInputLayout) {
    ...
    private boolean shouldUseTextInputLayoutFocusedRect(@q0 TextInputLayout textInputLayout) {
    ...
    public TextInputEditText(@o0 Context context, @q0 AttributeSet attributeSet, int i7) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i7, 0), attributeSet, i7);
        this.parentRect = new Rect();
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TextInputEditText, i7, R.style.Widget_Design_TextInputEditText, new int[0]);
