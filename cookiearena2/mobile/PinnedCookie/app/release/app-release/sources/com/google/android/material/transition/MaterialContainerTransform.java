...
public final class MaterialContainerTransform extends j0 {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private TransitionDrawable(z zVar, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f7, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f8, @l int i7, @l int i8, @l int i9, int i10, boolean z6, boolean z7, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z8) {
            ...
            PathMeasure pathMeasure = new PathMeasure(zVar.getPath(motionPathPoint.x, motionPathPoint.y, motionPathPoint2.x, motionPathPoint2.y), false);
    ...
    private ProgressThresholdsGroup buildThresholdsGroup(boolean z6) {
        ...
        return ((pathMotion instanceof b) || (pathMotion instanceof MaterialArcMotion)) ? getThresholdsOrDefault(z6, DEFAULT_ENTER_THRESHOLDS_ARC, DEFAULT_RETURN_THRESHOLDS_ARC) : getThresholdsOrDefault(z6, DEFAULT_ENTER_THRESHOLDS, DEFAULT_RETURN_THRESHOLDS);
    }
    ...
    private static void captureValues(@o0 r0 r0Var, @q0 View view, @d0 int i7, @q0 ShapeAppearanceModel shapeAppearanceModel) {
        if (i7 != -1) {
            r0Var.f6757b = TransitionUtils.findDescendantOrAncestorById(r0Var.f6757b, i7);
        } else if (view != null) {
            r0Var.f6757b = view;
        } else if (r0Var.f6757b.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) r0Var.f6757b.getTag(R.id.mtrl_motion_snapshot_view);
            r0Var.f6757b.setTag(R.id.mtrl_motion_snapshot_view, null);
            r0Var.f6757b = view2;
        }
        View view3 = r0Var.f6757b;
        ...
        r0Var.f6756a.put(PROP_BOUNDS, relativeBounds);
        r0Var.f6756a.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view3, relativeBounds, shapeAppearanceModel));
    }
    ...
    public void captureEndValues(@o0 r0 r0Var) {
        captureValues(r0Var, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    @Override // androidx.transition.j0
    public void captureStartValues(@o0 r0 r0Var) {
        captureValues(r0Var, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }
    ...
    public Animator createAnimator(@o0 ViewGroup viewGroup, @q0 r0 r0Var, @q0 r0 r0Var2) {
        ...
        if (r0Var != null && r0Var2 != null) {
            RectF rectF = (RectF) r0Var.f6756a.get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) r0Var.f6756a.get(PROP_SHAPE_APPEARANCE);
            if (rectF != null && shapeAppearanceModel != null) {
                RectF rectF2 = (RectF) r0Var2.f6756a.get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) r0Var2.f6756a.get(PROP_SHAPE_APPEARANCE);
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View view2 = r0Var.f6757b;
                final View view3 = r0Var2.f6757b;
                ...
                addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.MaterialContainerTransform.2
                    @Override // com.google.android.material.transition.TransitionListenerAdapter, androidx.transition.j0.h
                    ...
                    @Override // com.google.android.material.transition.TransitionListenerAdapter, androidx.transition.j0.h
                    public void onTransitionStart(@o0 j0 j0Var) {
    ...
    @Override // androidx.transition.j0
    public void setPathMotion(@q0 z zVar) {
