...
public class RippleUtils {
    ...
    public static class RippleUtilsLollipop {
        ...
        @u
        public static Drawable createOvalRipple(@o0 Context context, @u0 int i7) {
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setColor(-1);
            gradientDrawable.setShape(1);
            return new RippleDrawable(MaterialColors.getColorStateList(context, R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i7, i7, i7, i7));
        }
    }
    ...
    @o0
    public static ColorStateList convertToRippleDrawableColor(@q0 ColorStateList colorStateList) {
    ...
    @o0
    @w0(21)
    public static Drawable createOvalRippleLollipop(@o0 Context context, @u0 int i7) {
        return RippleUtilsLollipop.createOvalRipple(context, i7);
    }

    @TargetApi(21)
    @l
    private static int doubleAlpha(@l int i7) {
        return p0.B(i7, Math.min(Color.alpha(i7) * 2, 255));
    }

    @l
    private static int getColorForState(@q0 ColorStateList colorStateList, int[] iArr) {
        int colorForState = colorStateList != null ? colorStateList.getColorForState(iArr, colorStateList.getDefaultColor()) : 0;
        return USE_FRAMEWORK_RIPPLE ? doubleAlpha(colorForState) : colorForState;
    }

    @o0
    public static ColorStateList sanitizeRippleDrawableColor(@q0 ColorStateList colorStateList) {
    ...
    public static boolean shouldDrawRippleCompat(@o0 int[] iArr) {
        boolean z6 = false;
        boolean z7 = false;
        for (int i7 : iArr) {
            if (i7 == 16842910) {
