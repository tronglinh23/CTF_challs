...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public final void addAnimationListener(@o0 Animator.AnimatorListener animatorListener) {
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        return (MotionSpec) s.l(this.defaultMotionSpec);
    }
    ...
    @Override // com.google.android.material.floatingactionbutton.MotionStrategy
    public final void removeAnimationListener(@o0 Animator.AnimatorListener animatorListener) {
        this.listeners.remove(animatorListener);
    }

    @Override // com.google.android.material.floatingactionbutton.MotionStrategy
    public final void setMotionSpec(@q0 MotionSpec motionSpec) {
        this.motionSpec = motionSpec;
    }

    @o0
    public AnimatorSet createAnimator(@o0 MotionSpec motionSpec) {
