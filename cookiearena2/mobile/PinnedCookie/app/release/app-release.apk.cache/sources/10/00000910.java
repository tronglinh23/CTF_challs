...
public class MotionTiming {
    ...
    @o0
    public static MotionTiming createFromAnimator(@o0 ValueAnimator valueAnimator) {
    ...
    private static TimeInterpolator getInterpolatorCompat(@o0 ValueAnimator valueAnimator) {
    ...
    public void apply(@o0 Animator animator) {
    ...
    public MotionTiming(long j7, long j8, @o0 TimeInterpolator timeInterpolator) {
        this.repeatCount = 0;
        this.repeatMode = 1;
        this.delay = j7;
        this.duration = j8;
