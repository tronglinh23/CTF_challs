...
public final class i {
    public static /* synthetic */ boolean a(Set set, Activity activity) {
        return p(set, activity);
    }

    public static /* synthetic */ boolean b(y yVar, WindowMetrics windowMetrics) {
        return t(yVar, windowMetrics);
    }

    public static /* synthetic */ boolean c(i iVar, Set set, Pair pair) {
        return l(iVar, set, pair);
    }

    public static /* synthetic */ boolean d(i iVar, Set set, Pair pair) {
        return n(iVar, set, pair);
    }

    public static /* synthetic */ boolean e(Set set, Intent intent) {
        return r(set, intent);
    }
    ...
    public final Predicate<Pair<Activity, Intent>> k(@n6.d final Set<u> set) {
        ...
        return new Predicate() { // from class: u3.d
            ...
            public final boolean test(Object obj) {
                return i.c(i.this, set, (Pair) obj);
            }
        };
    }
    ...
    public final Predicate<Pair<Activity, Activity>> m(@n6.d final Set<u> set) {
        ...
        return new Predicate() { // from class: u3.h
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return i.d(i.this, set, (Pair) obj);
            }
        };
    }
    ...
    public final Predicate<WindowMetrics> s(@n6.d final y yVar) {
        ...
        return new Predicate() { // from class: u3.f
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return i.b(y.this, (WindowMetrics) obj);
            }
        };
    }
}