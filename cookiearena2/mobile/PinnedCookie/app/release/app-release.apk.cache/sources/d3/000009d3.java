...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@o0 Canvas canvas, int i7, float f7) {
    ...
    private void drawDebugMode(@o0 Canvas canvas) {
        ...
        if (shouldDrawCircularReveal()) {
            drawDebugCircle(canvas, u1.f3816t, 10.0f);
            drawDebugCircle(canvas, a.f17311c, 5.0f);
        }
        drawOverlayDrawable(canvas);
    }

    private void drawOverlayDrawable(@o0 Canvas canvas) {
    ...
    private float getDistanceToFurthestCorner(@o0 CircularRevealWidget.RevealInfo revealInfo) {
    ...
    private boolean shouldDrawCircularReveal() {
        ...
        return STRATEGY == 0 ? !z6 && this.hasCircularRevealCache : !z6;
    }
    ...
    public void setCircularRevealScrimColor(@l int i7) {
