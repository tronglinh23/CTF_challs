...
(function (root, factory) {
  ...
  (function () {
    ...
    C_enc.Utf16LE = {stringify: function (wordArray) {
      ...
      var utf16Chars = [];
      for (var i = 0; i < sigBytes; i += 2) {
        var codePoint = (words[i >>> 2] >>> 16 - i % 4 * 8 & 65535) << 8 & 4278255360 | (words[i >>> 2] >>> 16 - i % 4 * 8 & 65535) >>> 8 & 16711935;
        utf16Chars.push(String.fromCharCode(codePoint));
      }
      return utf16Chars.join("");
    }, parse: function (utf16Str) {
      ...
      var words = [];
      for (var i = 0; i < utf16StrLength; i++) {
        words[i >>> 1] |= utf16Str.charCodeAt(i) << 16 - i % 2 * 16 << 8 & 4278255360 | utf16Str.charCodeAt(i) << 16 - i % 2 * 16 >>> 8 & 16711935;
      }
      return WordArray.create(words, utf16StrLength * 2);
    }};
  }());
  ...
  (function () {
    ...
    var WordArray = C_lib.WordArray;
    var C_enc = C.enc;
    var Base64url = C_enc.Base64url = {stringify: function (wordArray, urlSafe = true) {
      var words = wordArray.words;
      var sigBytes = wordArray.sigBytes;
  ...
  (function (Math) {
    ...
    (function () {
      ...
      while (nPrime < 64) {
        if (isPrime(n)) {
          if (nPrime < 8) {
            H[nPrime] = (Math.pow(n, 0.5) - (Math.pow(n, 0.5) | 0)) * 4294967296 | 0;
          }
          K[nPrime] = (Math.pow(n, 0.3333333333333333) - (Math.pow(n, 0.3333333333333333) | 0)) * 4294967296 | 0;
          nPrime++;
        }
        n++;
      }
  ...
  (function () {
    ...
    var C_algo = C.algo;
    var K = [X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments), X64Word.create.apply(X64Word, arguments)];
    var W = [];
    (function () {
      for (var i = 0; i < 80; i++) {
        W[i] = X64Word.create.apply(X64Word, arguments);
      }
    }());
  ...
  (function () {
    ...
    var PBKDF2 = C_algo.PBKDF2 = Base.extend({cfg: Base.extend({keySize: 4, hasher: SHA1, iterations: 1}), init: function (cfg) {
      this.cfg = this.cfg.extend(cfg);
  ...
  (function () {
    ...
    var C_algo = C.algo;
    var MD5 = C_algo.MD5;
    var EvpKDF = C_algo.EvpKDF = Base.extend({cfg: Base.extend({keySize: 4, hasher: MD5, iterations: 1}), init: function (cfg) {
      this.cfg = this.cfg.extend(cfg);
    }, compute: function (password, salt) {
      var block;
      var cfg = this.cfg;
