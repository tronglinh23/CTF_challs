...
public class JarRsrcLoader
{
    ...
    public static void main(final String[] args) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException, IOException {
        ...
        final ClassLoader jceClassLoader = new URLClassLoader(rsrcUrls, getParentClassLoader());
    ...
    private static ClassLoader getParentClassLoader() throws InvocationTargetException, IllegalAccessException {
        try {
            Class class$0;
            if ((class$0 = JarRsrcLoader.class$0) == null) {
                try {
                    class$0 = (JarRsrcLoader.class$0 = Class.forName("java.lang.ClassLoader"));
                }
                catch (ClassNotFoundException ex) {
                    throw new NoClassDefFoundError(ex.getMessage());
                }
            }
            final Method platformClassLoader = class$0.getMethod("getPlatformClassLoader", (Class[])null);
